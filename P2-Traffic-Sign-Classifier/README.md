...
The following figure shows top 5 prediction on 10 new images with size of 32 X 32
...
The following figure shows accuracy and loss on two datasets(training, test) after the measurements approach stable 
