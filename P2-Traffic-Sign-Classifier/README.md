...
<p align="center">The workflow of model training strategy</p>
...
<p align="center">The following figure shows confusion matrix and the performance in each class.</p>
...
<p align="center">The following figure shows (from left to right) the misclassfied example (class 8) of the sign "Speed limit (120km/h)", its (class 8) result after sharpening, its (class 8) result after CLAHE, the example of predicted class "Dangerous curve to the left" and its (class 19) result after CLAHE</p>

![alt text][image7]

<p align="center">The following figure shows (from left to right) the misclassfied example (class 4) of the sign "Speed limit (70km/h)", its (class 4) result after sharpening, its (class 4) result after CLAHE, the example of predicted class "Dangerous curve to the left" and its (class 19) result after CLAHE</p>
...
<p align="center">The following figure shows more samples of the sign "Speed limit (70km/h)" (class 4)</p>

![alt text][image15]

<p align="center">The following figure shows more samples of the sign "Dangerous curve to the left" (class 19)</p>
...
<p align="center">The following figure shows top 5 prediction on 10 new images with size of 32X32</p>

![alt text][image4]

<p align="center">The following figure shows top 5 prediction on 5 new images with random size</p>
...
<p align="center">The following figure shows accuracy and loss on two datasets(training, test) after the measurements approach stable.</p>
...
### Appendix
---
The following figure shows 6 images for each class to visualize the signs in a general view.
![alt text][image1]